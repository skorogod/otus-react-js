...
export const BasicCard: FC<TBasicCardProps> = ({ backgroundColor, color, image, header, main, footer }) => {
  return (
    <article className={basicCardScss.card} style={{ backgroundColor: backgroundColor, color: color }}>
